...
interface UseDataTableProps<TData>
  ...
  /** Enable row expansion; use with DataTable's renderExpandedRow for custom expanded content */
  enableRowExpansion?: boolean;
  /** Optional: control which rows can expand (default: all rows when enableRowExpansion is true) */
...
export function useDataTable<TData>(props: UseDataTableProps<TData>) {
  ...
  const table = useReactTable({
    ...
    getRowCanExpand: enableRowExpansion ? getRowCanExpand : undefined,
    defaultColumn: {
