      ...
      <PopoverContent className="w-auto p-0" align="start">
        {multiple ? (
          <Calendar
            ...
            onSelect={onSelect}
            disabled={
              column.columnDef.meta?.calendarProps?.disabled
                ? column.columnDef.meta?.calendarProps?.disabled
                : false
            }
            startMonth={column.columnDef.meta?.calendarProps?.startMonth || new Date(2026, 0, 1)}
            endMonth={column.columnDef.meta?.calendarProps?.endMonth || new Date(2040, 0, 1)}
          />
        ) : (
          <Calendar
            captionLayout="dropdown"
