...
const sidebarNavItems = [
	{
        ...
        heading:"Profile",
        subHeading:"This is how others will see you on the site."
	},
	{
		title: "Account",
		href: "/settings/account",
        heading:"Account Type",
        subHeading:"Manage how your account is currently set up."
	},
...
export default function SettingsLayout({ children }: SettingsLayoutProps) {
    const pathname = usePathname();
    const isActive = sidebarNavItems.find(item => item.href === pathname);
	return (
			...
			<div className="flex flex-col space-y-6 lg:flex-row lg:space-x-8 lg:space-y-0">
                ...
                <Card className="flex-1" >
                    <CardHeader className="border-b">
                        ...
                        <CardTitle>{isActive?.heading}</CardTitle>
                        <CardDescription>{isActive?.subHeading}</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {children}
                    </CardContent>
