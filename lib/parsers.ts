...
/** URL query dates are strings; numeric-only values are ms since epoch (from pickers), not parseable by `new Date(string)`. */
export function queryDateParamToIso(value: string): string | undefined {
  const trimmed = parseInt(value) ?? undefined
